This project allows the user to enter a custom password, then simulates a "cracking" animation by gradually replacing random characters until the full password is revealed.
